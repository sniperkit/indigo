...
func (c *IndigoClientWrapper) GetIndex(ctx context.Context, includeIndexMapping bool, includeIndexType bool, includeKvstore bool, includeKvconfig bool, opts ...grpc.CallOption) (interface{}, error) {
...
func (c *IndigoClientWrapper) PutDocument(ctx context.Context, id string, fields map[string]interface{}, opts ...grpc.CallOption) (interface{}, error) {
	d := &proto.Document{
		Id: id,
	}
...
func (c *IndigoClientWrapper) GetDocument(ctx context.Context, id string, opts ...grpc.CallOption) (interface{}, error) {
...
func (c *IndigoClientWrapper) DeleteDocument(ctx context.Context, id string, opts ...grpc.CallOption) (interface{}, error) {
...
func (c *IndigoClientWrapper) Bulk(ctx context.Context, requests []map[string]interface{}, batchSize int32, opts ...grpc.CallOption) (interface{}, error) {
...
func (c *IndigoClientWrapper) Search(ctx context.Context, seardhRequests *bleve.SearchRequest, opts ...grpc.CallOption) (interface{}, error) {
...
func (c *IndigoClientWrapper) Close() error {
	return c.Conn.Close()
}
