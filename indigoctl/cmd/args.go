...
var (
	...
	highlightStyle   string   = defaultvalue.DefaultHighlightStyle
	highlightFields  []string = defaultvalue.DefaultHighlightFields
	includeLocations bool     = defaultvalue.DefaultIncludeLocations
)
